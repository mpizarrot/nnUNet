...
class DC_and_clDC_loss(nn.Module):
    def __init__(self, soft_dice_kwargs, weight_dice=1, weight_cldice=1, ignore_label=None):
        """
...
class nnUNetTrainerClDice(nnUNetTrainer):
    ...
    def _build_loss(self):
        loss = DC_and_clDC_loss({'batch_dice': self.configuration_manager.batch_dice,
                                   'smooth': 1e-5, 'do_bg': False, 'ddp': self.is_ddp}, weight_dice=1, weight_cldice=1,
