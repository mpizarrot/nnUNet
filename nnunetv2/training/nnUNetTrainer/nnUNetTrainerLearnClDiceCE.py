...
class clDC_and_CE_loss_learn(nn.Module):
    def __init__(self, soft_dice_kwargs, ce_kwargs, ignore_label=None):
        ...
        :param weight_dice:
        """
        super(clDC_and_CE_loss_learn, self).__init__()
    ...
    def forward(self, net_output: torch.Tensor, target: torch.Tensor):
        ...
        result = alpha * ce_loss + (1 - alpha) * dc_loss
        return result
    

class nnUNetTrainerLearnClDiceCE(nnUNetTrainer):
    @staticmethod
    ...
    def _build_loss(self):
        loss = clDC_and_CE_loss_learn({'batch_dice': self.configuration_manager.batch_dice,
