...
class SwinTransformer(nn.Module):
    ...
    def forward(self, x, normalize=True, return_all_tokens=None, mask=None):
        ...
        return [x0_out, x0_out, x1_out, x2_out, x3_out, x4_out]
...
class nnUNetTrainerSwin(nnUNetTrainer):
    @staticmethod
    def build_network_architecture(architecture_class_name: str,
        ...
        encoder = swin_3D()
        #chkpt = torch.load("/home/mpizarro/out/swin3D/teacher.pth", weights_only=False)["state_dict"]
        #encoder.load_state_dict(chkpt)
