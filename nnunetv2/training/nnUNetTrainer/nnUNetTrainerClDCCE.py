...
class DC_clDC_and_CE_loss(nn.Module):
    def __init__(self, soft_dice_kwargs, ce_kwargs, weight_ce=1, weight_dice=0.5, weight_cldice=0.5, ignore_label=None):
        """
...
class nnUNetTrainerClDCCE(nnUNetTrainer):
    @staticmethod
    ...
    def _build_loss(self):
        loss = DC_clDC_and_CE_loss({'batch_dice': self.configuration_manager.batch_dice,
